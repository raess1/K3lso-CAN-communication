...
################################################################################################################################################        
    ...
    def WriteFrame(self):   
        ...
        print(f'CANMsg.ID = {CANMsg.ID}')
        print(f'CANMsg.LEN = {CANMsg.LEN}')
        print(f'CANMsg.MSGTYPE = {CANMsg.MSGTYPE}')
        ...
        if self.m_RemoteCHB.get():
            ...
            for i in range(CANMsg.LEN):
                ...
                print(f'CANMsg.DATA[{i}] = {CANMsg.DATA[i]}')
                print(f'type(CANMsg.DATA[{i}] = {type(CANMsg.DATA[i])}')
